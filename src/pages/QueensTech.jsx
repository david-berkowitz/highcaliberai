      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <CategoryCard 
              title="Consumer Tech"
              description="B2C technology products or services designed for everyday use by consumers"
            />
            <CategoryCard 
              title="Enterprise Tech"
              description="B2B technology products or services used by businesses or organizations"
            />
            <CategoryCard 
              title="Sustainability"
              description="Innovative solutions for a healthy planet with positive environmental impact"
            />
            <CategoryCard 
              title="Community"
              description="Non-tech businesses delivering services in lifestyle, wellness, fashion, and e-commerce"
            />
            <CategoryCard 
              title="Food-Based"
              description="Food/beverage businesses as wholesalers, manufacturers, or retail (Queens location required)"
            />
          </div>
        </div>
      </section>
              ...
              <Card className="border-2 border-blue-200 hover:border-blue-600 hover:shadow-xl transition-all cursor-pointer h-full">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Curated AI marketing tools for SMBs on a budget
                  </p>
            ...
            <Link to={createPageUrl("Blog")}>
              <Card className="border-2 border-blue-200 hover:border-blue-600 hover:shadow-xl transition-all cursor-pointer h-full">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Latest insights on AI-powered marketing strategies
                  </p>
                  <div className="flex items-center gap-2 text-blue-600 font-medium text-sm">
                    Read Articles
                    <ArrowRight className="w-4 h-4" />
